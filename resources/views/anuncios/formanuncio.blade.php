...
<div class="form-group">
    ...
    <input class="form-control {{$errors->has('url')? 'is-invalid' :old('url')}}" type="text" name="url" id="url" value="{{ isset($anuncio->url) ? $anuncio->url : '' }}">
...
<div class="form-group">
    <input class="btn btn-primary" type="submit" value="{{ $Modo == 'Crear' ? 'Agregar Anuncio' : 'Editar Anuncio' }}">

</div>
<div class="form-group">
    <a class="btn btn-secondary" href="{{ url('anuncios/listanuncio') }}">Lista de Anuncios</a>
</div>
